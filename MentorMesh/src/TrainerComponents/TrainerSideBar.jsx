...
export function TrainerSideBar() {
  ...
  const menuItems = [
    { name: "Dashboard", icon: <FaTachometerAlt />, path: "/trainer/" },
    { name: "Create Course", icon: <FaPlus />, path: "/trainer/create-course" },
    { name: "Create Video", icon: <FaPhotoVideo />, path: "/trainer/create-video" },
    { name: "My Courses", icon: <FaBook />, path: "/trainer/my-courses" },
    { name: "Profile", icon: <FaUserCircle />, path: "/trainer/profile" },
  ];

  return (
    <aside className="w-full md:w-64 bg-[#1f1f1f] text-white min-h-screen shadow-md">
      <div className="p-6 text-center border-b border-gray-700">
        <h2 className="text-2xl font-bold text-purple-400">Trainer Panel</h2>
      </div>
